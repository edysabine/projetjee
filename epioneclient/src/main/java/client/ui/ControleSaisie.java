...
public class ControleSaisie {
	...
	public static void sendMail(String dest, String subject,String content) {
    	...
    	//autoriser lutilisation des ports sécurisés
	    ...
	    try {
	        ...
	        Notifications.create().title("Mail sent------------").showInformation();
	    } catch (MessagingException mex) {
	    	Notifications.create().title("Mail not send there is an error").showInformation();
